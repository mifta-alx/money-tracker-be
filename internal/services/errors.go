...
var (
	...
	ErrPercentageExceeded      = errors.New("percentage_exceeded")
	ErrTransferSameAccount     = errors.New("transfer_same_account")
	...
	ErrAmountCannotBeNegative  = errors.New("amount_cannot_be_negative")
